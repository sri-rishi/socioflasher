        ...
        <>
            ...
            >
                <div className="flex fle-row items-center gap-4">
                    ...
                    <input className="focus:outline-transparent w-full bg-transparent hover:cursor-text" placeholder={`What's on your mind, ${user.firstName}`} disabled/>
                </div>
                <Button className={"font-semibold bg-sky-600 py-1 px-6 rounded-2xl text-white hover:bg-sky-700"} text={"Add"}/>
            </div>
