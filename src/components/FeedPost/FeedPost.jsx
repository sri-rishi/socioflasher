...
export const FeedPost = () => {
    return (
        <div className="flex flex-col mt-20 border-solid border mx-4 max-w-lg shadow-md">
            <div className="flex flex-row items-center justify-between px-3 py-2 bg-gray-300">
            ...
            <div className="flex flex-col gap-4 px-3">
                ...
                <div className="flex flex-row w-full items-center gap-2 pb-4 text-base">
                    ...
                    <Button className="hover:text-sky-400" text={"Post"}/>
                </div>
            </div>
        </div>
    )
